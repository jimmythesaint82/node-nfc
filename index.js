const nfc = require('bindings')('nfc'),
    events = require('events'),
    ndef = require('ndef');

const inherits = function (target, source) {
...
exports.nfc.scan = function () {
    let device, devices, i, info, j, k, kv, mod, mods, prop, props, protocol, results, speeds, v, x;
